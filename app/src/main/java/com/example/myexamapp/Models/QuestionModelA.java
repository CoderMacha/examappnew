...
public class QuestionModelA {
    ...
    public QuestionModelA(String question, String optionA, String optionB, String optionC, String optionD, String correctAnsw, String key, int setNum) {
