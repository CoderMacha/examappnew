...
import com.example.myexamapp.databinding.ActivityStudentScheduledTestsBinding;
...
public class StudentScheduledTestsActivity extends AppCompatActivity {

    private ActivityStudentScheduledTestsBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityStudentScheduledTestsBinding.inflate(getLayoutInflater());
